...
#############
# sim is a matric, use to cal distance when clustering
# tlist2cdata is making a str to class
#############
def sim(idx1, idx2):
	global tptr
	global nDistCalc
...
def runAffinityPropagation(hashList,random_state):
	...
	#At the moment ‘precomputed’ and euclidean are supported.
	res = cluster.fit(data)
	return(res)
